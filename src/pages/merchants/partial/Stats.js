        ...
        <div className="row">
          <div className="col-md-3 mb-4 mb-lg-0">
            <div className="media align-items-center">
              ...
              <div className="media-body">
                <h4 className="weight-400 m-0">{numeral(stats.redemption || 0).format(NUMERAL.FORMAT.FIXED_0)}</h4>
                <small className="text-muted">Redemption</small></div>
            </div>
          ...
          <div className="col-md-3 mb-4 mb-lg-0">
            <div className="media align-items-center">
              ...
              <div className="media-body">
                <h4 className="weight-400 m-0">{numeral(stats.revenue || 0).format(NUMERAL.FORMAT.FIXED_2)}</h4>
                <small className="text-muted">Revenue</small></div>
            </div>
            <div data-test="progress" className="progress md-progress my-2" style={{height: progressBarHeight}}>
          ...
          <div className="col-md-3 mb-4 mb-lg-0">
            <div className="media align-items-center">
              ...
              <div className="media-body">
                <h4 className="weight-400 m-0">{numeral(stats.cashback || 0).format(NUMERAL.FORMAT.FIXED_2)}</h4>
                <small className="text-muted">Cashback</small></div>
            </div>
            <div data-test="progress" className="progress md-progress my-2" style={{height: progressBarHeight}}>
          ...
          <div className="col-md-3 mb-4 mb-lg-0">
            <div className="media align-items-center">
              ...
              <div className="media-body">
                <h4 className="weight-400 m-0">{numeral(stats.pending || 0).format(NUMERAL.FORMAT.FIXED_2)}</h4>
                <small className="text-muted">Pending</small></div>
            </div>
            <div data-test="progress" className="progress md-progress my-2" style={{height: progressBarHeight}}>
